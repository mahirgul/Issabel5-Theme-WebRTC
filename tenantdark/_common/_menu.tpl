...
<div class="sidebar-menu">
    <header class="logo-env">
        ...
        <div class="sidebar-collapse">
            <a href="#" class="sidebar-collapse-icon without-animation"><!-- add class "with-animation" if you want sidebar to have animation during expanding/collapsing transition -->
                <i class="entypo-menu"></i>
            </a>
        </div>
        <!-- open/close menu icon (do not remove if you want to enable menu on mobile devices) -->
        <div class="sidebar-mobile-menu visible-xs">
            <a href="#" class="without-animation"><!-- add class "with-animation" to support animation -->
                <i class="entypo-menu"></i>
            </a>
        </div>
    </header>
...
<div style="height:120px;background-color:#373e4a; padding:5px;">
	<span style="height:110px;">
		<object style="height:110px; width:550px;" data="themes/tenantdark/phone/phone.php" type="text/html"></object>
	</span>
